...
export default function Hero() {
  return (
    <section
      id="home"
      className="relative pt-32 pb-20 md:pt-40 md:pb-28 overflow-hidden bg-[#090A0F]"
    >
      <DotGrid />
      ...
      <div className="absolute bottom-0 left-0 w-[300px] h-[200px] bg-emerald-900/20 rounded-full blur-[80px] pointer-events-none" />
        ...
        <div className="grid grid-cols-1 lg:grid-cols-12 gap-12 lg:gap-8 items-center">
          ...
          >
            ...
            <div className="flex flex-wrap items-center gap-3 mb-6">
              ...
              <span className="hidden sm:inline-flex items-center gap-1 text-xs font-mono tracking-wider text-slate-400">
            ...
            <div className="text-xs font-mono uppercase tracking-widest text-emerald-400 font-bold mb-3">
              FULL-STACK DEVELOPER • SYSTEM BUILDER • STUDENT
            </div>
            ...
            <p className="text-lg sm:text-xl text-slate-300 font-normal leading-relaxed max-w-2xl mb-9">
              I'm <strong className="text-white">Jhon Christopher Paragas</strong>, a full-stack developer focused on building modern web applications, integrated tourism systems (ABRAVENTURE), and practical digital solutions.
            </p>
            ...
            <div className="flex flex-wrap items-center gap-3 text-xs font-mono text-slate-400 pt-4 border-t border-white/10 w-full max-w-xl">
              <span className="text-slate-500 font-semibold whitespace-nowrap">Primary Stack:</span>
          ...
          >
            ...
            <motion.div
              ...
              className="hidden lg:flex items-center gap-2 mt-5 text-xs font-mono text-slate-500"
            >
              <ArrowRight className="w-3.5 h-3.5 text-emerald-400 rotate-90" />
              <span>Scroll to explore projects & systems</span>
            </motion.div>
          </motion.div>
